 ...
 * @date Jul 20, 2015
 */
abstract class AbstractRemoveThread extends Thread{
	...
	static long process(final int threads, final int min, final int max, AbstractKmerTableSet tables, boolean print){
		Timer t=new Timer();
