...
//			System.err.println("prebits="+prebits+", currentPass="+currentPass);
		...
		if(onePass){
			assert(filter==null) : "Multiple filtering passes are not allowed in onepass mode.";
...
//	public abstract CoverageArray3 fillHistogram(int histMax);
	...
	public abstract boolean dumpKmersAsText(String fname, int minToDump, boolean printTime);
	
//	public final CoverageArray3 makeKhist(String fname, int cols, int max, boolean printHeader, boolean printZeros, boolean printTime, boolean smooth){
//		Timer t=new Timer();
//		t.start();
//		
//		CoverageArray3 ca=fillHistogram(max);
//		if(smooth){
//			ca.array=CallPeaks.smoothProgressive(ca.array, 1);
//		}
