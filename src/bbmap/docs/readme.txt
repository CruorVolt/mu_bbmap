...
Alex Copeland (JGI), Douglas Jacobsen (JGI/NERSC), sdriscoll (SeqAnswers), Jon Rood (JGI/NERSC), and Elmar Pruesse (UC Denver).
...
**TODO: Compare Seal performance with and correctness with countvector flag.  One may be faster for large numbers of ref sequences.
TODO: Seal mcf flag.
TODO: Represent covariant depth as a vector with 1.0 for max depth.
...
TODO: Adapter-trim CLRS libraries... or not?  Shouldn't matter.
TODO: Speed up shaving (exploration) where possible.

TODO: Update BBMerge C code.
